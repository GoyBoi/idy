...
const lightThemeColors = ['#5227FF', '#FF9FFC', '#B19EEF'];
const darkThemeColors = ['#5227FF', '#FF9FFC', '#B19EEF'];
...
export default function LiquidEther({
  ...
  const effectiveColors = colors || (theme === 'light' ? lightThemeColors : darkThemeColors);
  ...
  useEffect(() => {
    ...
    const paletteTex = makePaletteTexture(effectiveColors);
