        ...
        <div className="flex items-center space-x-4">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            <SheetTrigger asChild>
              <Button variant="ghost" size="icon" className="md:hidden p-2 rounded-full hover:bg-foreground/10 transition-colors">
              ...
              <div className="flex flex-col items-center justify-between h-full py-4 bg-white dark:bg-gray-900">
                ...
                <div className="flex flex-col space-y-3 w-full px-4">
                  ...
                  <Button 
                    asChild 
                    variant="outline" 
                    className="w-full py-4 rounded-lg border border-border hover:bg-foreground/10 transition-colors text-foreground font-semibold flex items-center justify-center"
                  >
                    <a 
